...
위의 코드를 해석하면 employee 이름의 table에서 col 열의 합을 불러와 출력한다.
...
부서의 평균봉급이 300 미만인 마케팅팀이 조건에 의해 걸러진 것을 확인할 수 있다.  
...
이름을 오름차순(ASC)를 넣으니 위 사진과 다르게 **같은 봉급 값 안**에서 이름 기준으로 새로 정렬되었다.
